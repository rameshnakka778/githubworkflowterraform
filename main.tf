...
module "blackberry" {
    source = "git@github.com:rameshnakka778/githubworkflowterraform.git//packages/modules/blackberry_infra/gluesourcecreation?ref=main"
...
module "blackberryglues3"{
    source = "git@github.com:rameshnakka778/githubworkflowterraform.git//packages/modules/blackberry_infra/glues3?ref=main"
    upload_obj_path = var.s3_upload_obj_path
    #bucket_name_obj_upload="js-s3-aws-glue-bb"
}
module "blackberrysecretmanager" {
    source = "git@github.com:rameshnakka778/githubworkflowterraform.git//packages/modules/blackberry_infra/gluesecretmanager?ref=main"
...
module "blackberryterraform" {
    ...
    source                      = "git@github.com:rameshnakka778/githubworkflowterraform.git//packages/modules/blackberry_infra/gluejobdeployment?ref=main"
